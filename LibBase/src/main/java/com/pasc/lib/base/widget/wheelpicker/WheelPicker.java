package com.pasc.lib.base.widget.wheelpicker;
...
//    private static final String TAG = WheelPicker.class.getSimpleName();
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mItemTextColor = a.getColor(R.styleable.WheelPicker_wheel_item_text_color, getResources().getColor(R.color.black_333333));
        ...
        mIndicatorColor = a.getColor(R.styleable.WheelPicker_wheel_indicator_color, getResources().getColor(R.color.blue_4d73f4));
        ...
        mCurtainColor = a.getColor(R.styleable.WheelPicker_wheel_curtain_color, getResources().getColor(R.color.red_d83e51));
...
//        int indicatorHeadCenterY = mWheelCenterY + mHalfItemHeight + SizeUtils.dp2px(5);
//        int indicatorFootCenterY = mWheelCenterY - mHalfItemHeight - SizeUtils.dp2px(5);
...
//    }
    ...
    private void drawLine(Canvas canvas) {
        ...
        if (mIndicatorMarginLeft == 0)
            mIndicatorMarginLeft = -SizeUtils.dp2px(2);
        if (mIndicatorMarginRight == 0)
            mIndicatorMarginRight = -SizeUtils.dp2px(2);

        //上指示器
        RectF upRectF = new RectF(mIndicatorMarginLeft, mHalfWheelHeight - (mHalfItemHeight + SizeUtils.dp2px(0)) - mIndicatorSize / 2,
                mRectDrawn.right - mIndicatorMarginRight, mHalfWheelHeight - (mHalfItemHeight + SizeUtils.dp2px(0)) + mIndicatorSize / 2);
        canvas.drawRoundRect(upRectF, 2.5f, 2.5f, linePaint);   //圆角标记线

        //下指示器
        RectF downRectF = new RectF(mIndicatorMarginLeft, mHalfWheelHeight + (mHalfItemHeight + SizeUtils.dp2px(0)) - mIndicatorSize / 2,
                mRectDrawn.right - mIndicatorMarginRight, mHalfWheelHeight + (mHalfItemHeight + SizeUtils.dp2px(0)) + mIndicatorSize / 2);
    ...
    private void computeCurrentItemRect() {
        ...
        mRectCurrentItem.set(mRectDrawn.left, mWheelCenterY - mHalfItemHeight - SizeUtils.dp2px(5), mRectDrawn.right,
                mWheelCenterY + mHalfItemHeight + SizeUtils.dp2px(5));
    }
