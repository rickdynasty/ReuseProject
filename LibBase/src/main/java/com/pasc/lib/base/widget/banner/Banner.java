...
import com.pasc.lib.base.widget.banner.listener.OnBannerClickListener;
import com.pasc.lib.base.widget.banner.loader.ImageLoaderInterface;
import com.pasc.lib.base.widget.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private boolean useIndicatorDrawableSize;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorBottomMargin = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_bottom_margin, 0);
        mIndicatorRightMargin = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_right_margin, 0);
        useIndicatorDrawableSize = typedArray.getBoolean(R.styleable.Banner_use_indicator_drawable_size, false);
        typedArray.recycle();
    }
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        MarginLayoutParams layoutParams = (MarginLayoutParams) indicator.getLayoutParams();
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                    useIndicatorDrawableSize ? ViewGroup.LayoutParams.WRAP_CONTENT : mIndicatorWidth,
                    useIndicatorDrawableSize ? ViewGroup.LayoutParams.WRAP_CONTENT : mIndicatorHeight);
