...
public class GlideImageView extends ShapeImageView {
    ...
    private GlideImageLoader mGlideGlideImageLoader;
    ...
    private void init() {
        mGlideGlideImageLoader = GlideImageLoader.create(this);
    }

    public GlideImageLoader getImageLoader() {
        if (mGlideGlideImageLoader == null) {
            mGlideGlideImageLoader = GlideImageLoader.create(this);
        }
        return mGlideGlideImageLoader;
    }
